...
<p align="justify">
O projeto tinha como objetivo aprender TypeScript e utilizar o SASS para gerar o CSS do aplicativo. Foi desenvolvido um aplicativo de entrega de comida, onde o usuário pode escolher entre uma variedade de itens listados em três diferentes menus. Ao selecionar um item, ele é adicionado ao carrinho de compras, utilizando um arquivo de contexto para gerenciar os estados. O carrinho possui algumas funcionalidades, como a remoção de itens, adição de novos itens e exibição do preço total da compra.
</p>

## Acesse

<a href="https://cafeteria-tau.vercel.app/">Acesse a aplicação clicando aqui</a>.

## Video do projeto

<a href="https://www.youtube.com/watch?v=dGRaykYNlXo">Video do projeto aqui</a>.
